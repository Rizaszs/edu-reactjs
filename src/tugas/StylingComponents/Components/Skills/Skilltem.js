...
export default function Skilltem() {
  return (
    <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      <div className="bg-yellow-600 rounded-xl hover:bg-rose-500 transition duration-500 hover:scale-110 hover:text-white">
        <div className="p-12">
          ...
          <div className="">
            <h5 className="text-1xl font-bold pb-3">NodeJS</h5>
            <p className="text-sm">
              Node.js is an open-source, cross-platform, back-end JavaScript
              runtime environment that runs on the V8 engine executes JavaScript
